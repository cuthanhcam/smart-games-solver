...
class _UserActivityScreenState extends State<UserActivityScreen> with TickerProviderStateMixin {
  ...
  Future<void> _loadActivityData() async {
    ...
    try {
      ...
      // Load login history
      final loginKeys = prefs.getKeys().where((key) => key.startsWith('login_history_')).toList();
      _loginHistory = [];
      ...
      // Load game history
      final gameKeys = prefs.getKeys().where((key) => key.startsWith('game_history_')).toList();
      _gameHistory = [];
        ...
        child: Column(
          ...
          children: [
            ...
            if (_loginHistory.isEmpty)
              ...
              Column(
                children: _loginHistory.take(10).map((login) => Container(
                      ...
                      CircleAvatar(
                        ...
                        child: Text(
                          login['username'].toString().isNotEmpty
                              ? login['username'].toString().characters.first.toUpperCase()
                              : 'U',
                          style: TextStyle(
                            color: Colors.blue[700],
                            fontSize: 12,
        ...
        child: Column(
          ...
          children: [
            ...
            if (_gameHistory.isEmpty)
              ...
              Column(
                children: _gameHistory.take(10).map((game) => Container(
                  margin: const EdgeInsets.only(bottom: 8),
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: Colors.white,
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _getGameColor(game['game']).withOpacity(0.1),
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  child: Text(
