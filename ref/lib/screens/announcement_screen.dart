...
class _AnnouncementScreenState extends State<AnnouncementScreen> {
  ...
  Future<void> _createAnnouncement() async {
    ...
    try {
      await _repo.createAnnouncement(
        ...
        createdBy: 'Admin', // Có thể lấy từ current user
        // displayDurationMinutes: _displayDuration, // Đã bỏ chức năng
      );
  ...
  Future<void> _toggleAnnouncementStatus(Announcement announcement) async {
    try {
      await _repo.updateAnnouncementStatus(announcement.id!, !announcement.isActive);
      _loadAnnouncements();
                  ...
                  Row(
                    children: [
                      Icon(
                        Icons.info_outline, 
                        size: 16, 
                        color: announcement.isActive ? Colors.green[600] : Colors.grey[600]
                      ),
                      const SizedBox(width: 8),
                      Text(
                        announcement.isActive ? 'Trạng thái: Đang hiển thị' : 'Trạng thái: Đã ẩn',
                        style: TextStyle(
                          fontSize: 14, 
                          color: announcement.isActive ? Colors.green[600] : Colors.grey[600],
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                      borderSide: BorderSide(color: const Color(0xFFDC2626).withOpacity(0.5)),
                    ),
                    ...
                    prefixIcon: const Icon(Icons.title, color: Color(0xFFDC2626)),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: Colors.white,
                    prefixIcon: const Icon(Icons.description, color: Color(0xFFDC2626)),
                    hintStyle: const TextStyle(color: Colors.grey),
                  ),
                  maxLines: 2,
                ),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          icon: Icon(
                                            announcement.isActive ? Icons.visibility : Icons.visibility_off,
                                            color: announcement.isActive ? Colors.green[600] : Colors.grey[600],
                                            size: 18,
                                          ),
                                          tooltip: announcement.isActive ? 'Ẩn thông báo' : 'Hiện thông báo',
