...
class _AnnouncementDetailScreenState extends State<AnnouncementDetailScreen> {
  ...
  Future<void> _checkIfRead() async {
    ...
    try {
      final isRead = await _repo.isAnnouncementReadByUser(widget.userId, widget.announcement.id!);
      if (mounted) {
        setState(() {
          _isRead = isRead;
        });
  ...
  Future<void> _markAsRead() async {
    ...
    try {
      await _repo.markAnnouncementAsRead(widget.userId, widget.announcement.id!);
      if (mounted) {
        setState(() {
          _isRead = true;
        });
