...
import '../widgets/gradient_snackbar.dart';
...
class _FriendsScreenState extends State<FriendsScreen> with TickerProviderStateMixin {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final receivedRequests = await _friendRepo.getReceivedFriendRequests(_currentUserId);
      final sentRequests = await _friendRepo.getSentFriendRequests(_currentUserId);
  ...
  Future<void> _searchUser() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        final areFriends = await _friendRepo.areFriends(_currentUserId, user['id']);
        ...
        final requestStatus = await _friendRepo.getFriendRequestStatus(_currentUserId, user['id']);
        
        if (requestStatus == 'pending') {
          // Kiểm tra xem ai là người gửi
          final sentRequests = await _friendRepo.getSentFriendRequests(_currentUserId);
          final isSentByMe = sentRequests.any((req) => req['receiver_id'] == user['id']);
          ...
          padding: const EdgeInsets.all(16),
            ...
            onChanged: _filterFriends,
              ...
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: BorderSide(color: const Color(0xFF57BCCE).withOpacity(0.5)),
              ),
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: IconButton(
                                onPressed: () => _openChat(friend['friend_id'], friend['username']),
                            ...
                            Container(
                              ...
                              child: IconButton(
                                onPressed: () => _showRemoveFriendDialog(friend['friend_id'], friend['username']),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.person_search, color: Color(0xFF57BCCE)),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: const BorderSide(color: Color(0xFF57BCCE)),
              ),
