...
class _ChatDetailScreenState extends State<ChatDetailScreen> {
  ...
  Future<void> _loadMessages() async {
    try {
      final messages = await _messageRepo.getMessages(
  ...
  Widget _buildMessagesList() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        debugPrint('Message ${index}: senderId=${message.senderId}, currentUserId=${widget.currentUserId}, isMe=${message.senderId == widget.currentUserId}');
