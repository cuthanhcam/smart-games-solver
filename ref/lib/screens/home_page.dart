...
import '../minigames/rubik/rubik_main.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Future<void> _loadUser() async {
    try {
      ...
      if (user != null) {
        ...
        // Save login history
        await UserActivityHelper.saveLoginHistory(username: _username ?? 'Player');
  ...
  Future<String> _getCurrentUsername() async {
    try {
      ...
      debugPrint('GAME_HISTORY: Current user: ${user?.id}, username: $username');
  ...
  Future<void> _saveGameHistory(String gameName) async {
    try {
      ...
      debugPrint('GAME_HISTORY: Attempting to save $gameName game history for $username');
      ...
      debugPrint('GAME_HISTORY: Successfully saved $gameName game history for $username');
    } catch (e) {
        ...
        children: [
          ...
          _buildGameCard(
            ...
            onPlayTap: () async {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const RubikMain()),
              );
            },
          ),
        ],
