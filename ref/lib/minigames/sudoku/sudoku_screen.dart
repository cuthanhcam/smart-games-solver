...
class _SudokuScreenState extends State<SudokuScreen> with TickerProviderStateMixin {
  ...
  Set<int> _selectedAreaCells = {}; // Các ô trong vùng được chọn (3x3 + hàng + cột)
  ...
  void _onNumberTap(int n) {
    if (_puzzle == null || _state == null || _selected == null || _gameOver || _isPaused) return;
                  ...
                  child: DropdownButtonHideUnderline(
                    child: Theme(
                      ...
                      child: DropdownButton<String>(
                        ...
                        icon: const Icon(Icons.arrow_drop_down, color: Color(0xFF2D3748)),
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    color: _mistakes >= 3
                                        ? Colors.red
                                        : (_isMistakeFlashing ? Colors.red : Colors.grey[600]),
                                    fontSize: 14,
                        ...
                        builder: (context, snapshot) {
                          ...
                          final seconds = (elapsed.inSeconds % 60).toString().padLeft(2, '0');
                              return Text(
                                '$minutes:$seconds',
                                style: TextStyle(
                                  color: _isPaused ? Colors.grey[600] : const Color(0xFF2D3748),
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                ),
                              );
                          ...
                          GestureDetector(
                            ...
                            child: Icon(
                              ...
                              color: _isPaused ? Colors.green : const Color(0xFF2D3748),
                              size: 20,
                            ),
                          ),
                        ],
