...
class _CellWidgetState extends State<CellWidget> with TickerProviderStateMixin {
  ...
  void didUpdateWidget(CellWidget oldWidget) {
    ...
    if (widget.cellState != oldWidget.cellState && widget.cellState != CellState.empty) {
  ...
  Widget _buildSymbol() {
    ...
    final String assetPath = isX ? 'assets/caro/icon_x.jpg' : 'assets/caro/icon_o.jpg';
        ...
        return Transform.scale(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final double size = (constraints.biggest.shortestSide * 0.72).clamp(12.0, 26.0);
              return Center(
                child: Image.asset(
                  assetPath,
                  width: size,
