...
class _CaroHomeScreenState extends State<CaroHomeScreen> with TickerProviderStateMixin {
  ...
  void _saveCaroEntry() async {
    try {
      ...
      debugPrint('Caro home screen entry - history already saved from home page');
    } catch (e) {
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                ...
                                _buildSection(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      // Độ khó (chỉ hiển thị khi chọn PvE)
                                ...
                                // Thêm khoảng trống ở cuối để cuộn mượt
                                const SizedBox(height: 20),
                              ],
                            ),
                          ),
  ...
  Widget _buildModeOption(GameMode mode, String title, IconData icon, String subtitle) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? Colors.blue.shade400 : Colors.white.withOpacity(0.2),
            width: 1.5,
          ),
  ...
  Widget _buildDifficultyDropdown() {
    final difficulties = [
      {'difficulty': Difficulty.easy, 'title': 'Easy', 'subtitle': 'AI ngẫu nhiên', 'color': Colors.green},
      {'difficulty': Difficulty.normal, 'title': 'Normal', 'subtitle': 'AI cơ bản', 'color': Colors.orange},
      {'difficulty': Difficulty.hard, 'title': 'Hard', 'subtitle': 'AI nâng cao', 'color': Colors.red},
      {'difficulty': Difficulty.expert, 'title': 'Expert', 'subtitle': 'AI tối ưu', 'color': Colors.purple},
    ];

    final selectedDiff = difficulties.firstWhere(
      (diff) => diff['difficulty'] == selectedDifficulty,
    );
