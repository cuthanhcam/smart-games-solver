...
class _NotificationIconWidgetState extends State<NotificationIconWidget> {
  ...
  Future<void> _loadUnreadCount() async {
    ...
    try {
      print(
          'DEBUG NOTIFICATION ICON: Loading unread count for user $_currentUserId');
      ...
      if (mounted) {
        ...
        print(
            'DEBUG NOTIFICATION ICON: Updated unread count to: $_unreadCount');
      }
    } catch (e) {
  ...
  void _navigateToNotifications() {
    ...
    Navigator.push(
      ...
      print(
          'DEBUG NOTIFICATION ICON: Returned from notifications screen, refreshing count');
      _loadUnreadCount();
    });
  }
