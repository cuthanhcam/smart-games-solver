...
class _Game2048ScreenState extends State<Game2048Screen>
  ...
  Future<void> _saveBestIfNeeded() async {
    try {
      ...
      debugPrint(
          'DEBUG 2048: Successfully saved score ${board.score} for user: $username');
    } catch (e) {
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                            ...
                            side: const BorderSide(
                                color: Color(0xFF8B7355), width: 2),
                          ),
                        ),
                      ),
                    ),
                      ...
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(
                              0xFF8B7355), // Màu đậm hơn để phân biệt
                          ...
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(12),
                            side: const BorderSide(
                                color: Color(0xFF776E65), width: 2),
                          ),
                        ),
                      ),
                    ),
    ...
    return Expanded(
      child: Padding(
        ...
        child: ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor:
                enabled ? const Color(0xFF57BCCE) : Colors.grey[400],
            foregroundColor: Colors.white,
                    ...
                    child: Container(
                      ...
                      child: GestureDetector(
                        onVerticalDragEnd: (d) {
                          ...
                          _handleMove(
                              d.primaryVelocity! < 0 ? Dir.up : Dir.down);
                        },
                        onHorizontalDragEnd: (d) {
                          if (_mode != ToolMode.none) return;
                          if (d.primaryVelocity == null) return;
                          _handleMove(
                              d.primaryVelocity! < 0 ? Dir.left : Dir.right);
                        },
                        child: LayoutBuilder(
                          builder: (_, c) {
                            final size = min(c.maxWidth,
                                c.maxHeight); // KHÔNG trừ thêm ở đây
                            return _BoardView(
                              board: board,
                              side: size,
                              mode: _mode,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _toolButton(
                        ...
                        active: _mode == ToolMode.swapPickFirst ||
                            _mode == ToolMode.swapPickSecond,
                        enabled: swapCharges > 0 ||
                            _mode == ToolMode.swapPickFirst ||
                            _mode == ToolMode.swapPickSecond,
                        charges: swapCharges,
                      ),
                      ...
                      _toolButton(
                        ...
                        enabled:
                            deleteCharges > 0 || _mode == ToolMode.deletePick,
  ...
  Widget build(BuildContext context) {
    ...
    Color tileColor(int v) {
      ...
      switch (v) {
        ...
        default:
          return const Color(0xFF3C3A32); // >2048
      }
    }
    ...
    Color numColor(int v) {
      ...
      if (v <= 4)
        return const Color(0xFF776E65); // Chữ nâu xám cho số nhỏ (2, 4)
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
            color: const Color(0xFF8B7355), width: 2), // Viền màu nâu đậm
        boxShadow: [
          BoxShadow(
                ...
                Row(
                  children: [
                    for (var c = 0; c < n; c++) ...[
                      GestureDetector(
                        onTap:
                            onTapTile == null ? null : () => onTapTile!(r, c),
